        ...
        <table className="text-white  lg:w-[90%]  w-full  text-start">
          ...
          <tbody className="bg-white">
            <tr className="text-black/85">
              ...
              <td className="p-2 text-start">2</td>
              <td className="p-2 text-start">Full Time</td>
              <td className="p-2 text-start">3+</td>
...
export default ExperincedProfessionals;
