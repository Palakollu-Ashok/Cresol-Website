...
function Freshers() {
  return (
    <div className=" py-5 2xl:px-[160px] sm:px-[50px] px-[10px] sm:rounded-lg">
      <h1 className="text-center ">
        Current career opportunities at Cresol Infoserv
      </h1>
      <p className="py-5 leading-4 text-center text-white/75 ">
      ...
      <div className="flex overflow-x-auto lg:items-center lg:justify-center">
        <table className="text-white  lg:w-[90%] w-full   text-start">
